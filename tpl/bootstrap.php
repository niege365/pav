...
<!--					<img alt="<?php echo I18n::_($NAME); ?>" src="img/icon.svg" width="38" />-->
					<img alt="<?php echo I18n::_($NAME); ?>" src="logo.png" width="38" />
				</a>
			</div>
...
?>
			...
			<footer class="container">
				<div class="row">
					<p class="col-md-12 text-center" style="width: 100%;text-align: center;margin:0;font-size:12px;">Copyright ©2020 <a href="https://love2wind.com/" target="_blank" style="color:#333;">love2wind</a> All Rights Reserved.<a href="https://love2wind.cn/" target="_blank" style="color:#333;">涅槃博客</a> Powered by <a href="https://privatebin.info/" target="_blank" style="color:#333;"><?php echo I18n::_($NAME); ?></a><?php echo $VERSION; ?> | <a href="https://nie.ge/" target="_blank">短网址</a> | <a href="https://love2wind.cn/" target="_blank">博客</a> | <a href="https://imgsrc.xyz/" target="_blank">图床</a> | <a href="https://nicepub.top/" target="_blank">书苑</a> | <a href="https://nav.imgsrc.xyz/" target="_blank">导航</a> | </i><?php echo I18n::_('Because ignorance is bliss'); ?>，一个极简、加密的在线粘贴板</i></p>
					<!--<p class="col-md-1 col-xs-4 text-center" style="width: 300%;text-align: center;"></i><?php echo I18n::_('Because ignorance is bliss'); ?>，一个极简、加密的在线粘贴板</i></p>
					<p id="aboutbox" style="width: 40%;text-align: right;float: right;" class="col-md-6 col-xs-12"><a href="https://nie.ge/" target="_blank">短网址</a> | <a href="https://love2wind.cn/" target="_blank">博客</a> | <a href="https://imgsrc.xyz/" target="_blank">图床</a> | <a href="https://nicepub.top/" target="_blank">书苑</a> | <a href="https://nav.imgsrc.xyz/" target="_blank">导航</a></p>-->
				</div>
			</footer>
		</main>
<?php
