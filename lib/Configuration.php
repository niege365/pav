...
class Configuration
{
    ...
    private static $_defaults = array(
        'main' => array(
            ...
            'sizelimit'                => 2097152,
            'template'                 => 'bootstrap',
            'notice'                   => '请勿发布违法违规内容，一经发现，立即删除并记录ip地址提交有关部门。',
            'languageselection'        => true,
            'languagedefault'          => 'zh_CN',
            'urlshortener'             => '',
            'qrcode'                   => true,
            'icon'                     => 'identicon',
            'cspheader'                => 'default-src \'none\'; manifest-src \'self\'; connect-src * blob:; script-src \'self\' \'unsafe-eval\'; style-src \'self\'; font-src \'self\'; img-src \'self\' data: https: blob:; media-src blob:; object-src blob:; sandbox allow-same-origin allow-scripts allow-forms allow-popups allow-modals',
